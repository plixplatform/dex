...
def nodeVersionTag: String = "v1.1.3"

lazy val node = ProjectRef(uri(s"git://github.com/plixplatform/Plix.git#$nodeVersionTag"), "node")

lazy val `node-it` = ProjectRef(uri(s"git://github.com/plixplatform/Plix.git#$nodeVersionTag"), "node-it")
...
inScope(Global)(
  Seq(
    ...
    scmInfo := Some(ScmInfo(url("https://github.com/plixplatform/dex"), "git@github.com:plixplatform/dex.git", None)),
    licenses := Seq(("MIT", url("https://github.com/plixplatform/dex/blob/master/LICENSE"))),
    scalacOptions ++= Seq(
      "-feature",
      "-deprecation",
      "-unchecked",
