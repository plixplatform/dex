...
import com.plixplatform.it.{DockerContainerLauncher, MatcherSuiteBase}
import com.plixplatform.dex.history.DBRecords.{EventRecord, OrderRecord}
...
import com.plixplatform.dex.settings.{OrderHistorySettings, PostgresConnection}
...
class OrderHistoryTestSuite extends MatcherSuiteBase {
  ...
  val plixNetwork: Network = dockerSingleton().createNetwork
  ...
  import com.plixplatform.dex.history.HistoryRouter._
