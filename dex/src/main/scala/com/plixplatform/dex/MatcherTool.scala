...
import com.plixplatform.database._
import com.plixplatform.db.openDB
import com.plixplatform.dex.db.{AssetPairsDB, OrderBookSnapshotDB}
import com.plixplatform.dex.doc.MatcherErrorDoc
import com.plixplatform.dex.market.{MatcherActor, OrderBookActor}
import com.plixplatform.dex.model.{LimitOrder, OrderBook}
...
//  }
  ...
  def main(args: Array[String]): Unit = {
    ...
    val settings: MatcherSettings = actualConfig.as[MatcherSettings]("plix.dex")
    val db                        = openDB(settings.dataDir)
    val blockchainDb              = openDB(actualConfig.getString("plix.db.directory"))
