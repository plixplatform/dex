...
import com.plixplatform.dex.error.Class.{common => commonClass, _}
import com.plixplatform.dex.error.Entity.{common => commonEntity, _}
import com.plixplatform.dex.error.Implicits._
import com.plixplatform.dex.settings.{DeviationsSettings, OrderRestrictionsSettings}
import com.plixplatform.features.BlockchainFeature
...
case class InvalidAsset(theAsset: String)
    extends MatcherError(asset, commonEntity, broken, e"The asset '${'assetId -> theAsset}' is wrong. It should be 'PLIX' or a Base58 string")
