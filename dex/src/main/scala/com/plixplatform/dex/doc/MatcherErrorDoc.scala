package com.plixplatform.dex.doc

import com.plixplatform.dex.error.{Class, Entity, MatcherError}
import com.plixplatform.dex.meta.DescendantSamples
import com.plixplatform.dex.util.getSimpleName
...
object MatcherErrorDoc {
  ...
  def mkMarkdown: String = {
    val context = new com.plixplatform.dex.error.ErrorFormatterContext {
