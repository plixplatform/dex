package com.plixplatform.dex.matching
...
import com.plixplatform.dex.market.MatcherSpecLike
import com.plixplatform.dex.model.Events.{OrderAdded, OrderExecuted}
import com.plixplatform.dex.model.{LimitOrder, OrderHistoryStub}
import com.plixplatform.dex.{AssetPairDecimals, MatcherTestData, _}
...
class ReservedBalanceSpecification
  ...
  val pair = AssetPair(mkAssetId("PLIX"), mkAssetId("USD"))
