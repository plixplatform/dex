...
import com.plixplatform.http.RouteSpec
import com.plixplatform.state.Blockchain
import com.plixplatform.transaction.Asset
import com.plixplatform.{RequestGen, WithDB, crypto}
...
class MatcherApiRouteSpec extends RouteSpec("/matcher") with RequestGen with PathMockFactory with Eventually with WithDB {
  ...
  private val settings                       = MatcherSettings.valueReader.read(ConfigFactory.load(), "plix.dex")
