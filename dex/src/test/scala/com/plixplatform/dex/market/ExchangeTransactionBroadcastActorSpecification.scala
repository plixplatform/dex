...
import com.plixplatform.dex.model.Events.ExchangeTransactionCreated
import com.plixplatform.dex.settings.ExchangeTransactionBroadcastSettings
...
import com.plixplatform.transaction.assets.exchange.{AssetPair, ExchangeTransaction, ExchangeTransactionV2, Order}
...
class ExchangeTransactionBroadcastActorSpecification
  ...
  private val pair = AssetPair(IssuedAsset(Array.emptyByteArray), Plix)
