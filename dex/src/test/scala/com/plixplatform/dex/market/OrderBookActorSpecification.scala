...
import com.plixplatform.dex.api.AlreadyProcessed
import com.plixplatform.dex.db.OrderBookSnapshotDB
import com.plixplatform.dex.fixtures.RestartableActor
import com.plixplatform.dex.fixtures.RestartableActor.RestartActor
import com.plixplatform.dex.market.MatcherActor.SaveSnapshot
import com.plixplatform.dex.market.OrderBookActor._
import com.plixplatform.dex.model.Events.{OrderAdded, OrderCanceled}
import com.plixplatform.dex.model._
import com.plixplatform.dex.queue.QueueEvent.Canceled
...
class OrderBookActorSpecification
  ...
  private def obcTestWithPrepare(prepare: (OrderBookSnapshotDB, AssetPair) => Unit,
    ...
    val tp    = TestProbe()
    val pair  = AssetPair(IssuedAsset(b), Plix)
