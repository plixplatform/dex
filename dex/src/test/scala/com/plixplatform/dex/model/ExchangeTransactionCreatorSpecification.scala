...
import com.plixplatform.transaction.assets.exchange.{AssetPair, ExchangeTransactionV1, ExchangeTransactionV2}
...
class ExchangeTransactionCreatorSpecification
  ...
  private val pair = AssetPair(Plix, mkAssetId("BTC"))
