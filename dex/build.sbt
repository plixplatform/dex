...
val packageSettings = Seq(
  ...
  packageSummary := "DEX",
  packageDescription := s"Decentralized EXchange for Plix network. Compatible with ${nodeVersion.value} node version"
)
...
lazy val versionSourceTask = Def.task {
  ...
  val versionFile      = sourceManaged.value / "com" / "plixplatform" / "dex" / "Version.scala"
  ...
  IO.write(
    versionFile,
    s"""package com.plixplatform.dex
       |
       |object Version {
